...
//           <h2 style={{ textAlign: 'center', marginBottom: '40px' }}>Why Choose Reactutor?</h2>
//           <div style={{ display: 'flex', gap: '32px', flexWrap: 'wrap', justifyContent: 'center' }}>
//             {features.map((feat, idx) => (
//               <div key={idx} style={{ backgroundColor: feat.bg, padding: '30px', borderRadius: '12px', flex: '1 1 250px', maxWidth: '300px' }}>
